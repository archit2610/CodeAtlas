import { importDemoRepository, getTree, getFile, searchFiles, parseGithubUrl } from '../services/repository.service.js';
import { getDependents } from '../services/repository-tools.service.js';
async function runSmokeTest() {
    ...
    const snapshot = repo.snapshotJson;
