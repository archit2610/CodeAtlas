...
export const inspectRepositoryRoutes = async (repositoryId) => {
    const files = await db.select()
        .from(repositoryFiles)
        .where(and(eq(repositoryFiles.repositoryId, repositoryId)));
...
//# sourceMappingURL=route-inspector.service.js.map