...
import { getConversationsByGuest, getConversationById, getConversationReports, deleteConversation } from "../services/conversation.service.js";
;
export const getUserConversations = asyncHandler(async (req, res) => {
    const guestTempId = req.guestTempId || req.cookies?.scout_temp_id;
    if (!guestTempId)
        throw new ApiError(400, "Guest session is required");
